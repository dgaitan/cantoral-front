...
Error: locator.click: Error: strict mode violation: locator('a[href="/explorar"]') resolved to 4 elements:
    1) <a href="/explorar">Explorar</a> aka getByText('Explorar').first()
    ...
    4) <a href="/explorar" class="flex flex-col items-center gap-1 px-[14px] py-[2px] no-underline text-muted">…</a> aka getByRole('link', { name: 'Explorar' })
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e7]:
    ...
    - generic [ref=e18]:
      - paragraph [ref=e19]: Explora el catálogo de canciones
      - link "Ver canciones" [ref=e20] [cursor=pointer]:
        - /url: /explorar
  - navigation "Navegación principal" [ref=e22]:
    ...
    - link "Listas" [ref=e33] [cursor=pointer]:
      - /url: /listas
      - img [ref=e34]
      - generic [ref=e36]: Listas
    - link "Cuenta" [ref=e37] [cursor=pointer]:
      - /url: /login
      - img [ref=e38]
