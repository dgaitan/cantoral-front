...
- Name: auth-flow.spec.ts >> Register page >> shows name, email, password fields and Crear cuenta button
- Location: tests/e2e/auth-flow.spec.ts:167:7
...
- textbox "Contraseña (mín. 8 caracteres)"
- button "Crear cuenta"
