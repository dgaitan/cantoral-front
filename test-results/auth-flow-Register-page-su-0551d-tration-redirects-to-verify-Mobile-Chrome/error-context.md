...
- Name: auth-flow.spec.ts >> Register page >> successful registration redirects to /verify
- Location: tests/e2e/auth-flow.spec.ts:175:7
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e8]:
    ...
    - generic [ref=e12]:
      - generic [ref=e13]:
        - img [ref=e15]
        - textbox "Tu nombre" [ref=e18]
      - generic [ref=e19]:
        - img [ref=e21]
        - textbox "tu@correo.com" [ref=e24]
      - generic [ref=e25]:
        - img [ref=e27]
        - textbox "Contraseña (mín. 8 caracteres)" [ref=e30]
