...
- Name: auth-flow.spec.ts >> Login page >> successful login redirects to /verify
- Location: tests/e2e/auth-flow.spec.ts:127:7
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e13]:
    ...
    - heading "Ingresar" [level=1] [ref=e16]
    - generic [ref=e17]:
      - generic [ref=e18]:
        - img [ref=e20]
        - textbox "tu@correo.com" [ref=e23]
      - generic [ref=e24]:
        - img [ref=e26]
        - textbox "Contraseña" [ref=e29]
      - button "Ingresar" [ref=e30] [cursor=pointer]
    - generic [ref=e31]:
      - text: ¿No tienes cuenta?
      - link "Crear cuenta" [ref=e32] [cursor=pointer]:
        - /url: /register
  - navigation "Navegación principal" [ref=e33]:
    ...
    - link "Explorar" [ref=e39] [cursor=pointer]:
      - /url: /explorar
      - img [ref=e40]
      - generic [ref=e43]: Explorar
    - link "Listas" [ref=e44] [cursor=pointer]:
      - /url: /listas
      - img [ref=e45]
      - generic [ref=e47]: Listas
    - link "Cuenta" [ref=e48] [cursor=pointer]:
      - /url: /login
      - img [ref=e49]
      - generic [ref=e52]: Cuenta
...
```ts
  30  |         errors: ["Credenciales inválidas"],
  31  |         message: "",
  32  |       }),
  33  |     })
  34  |   );
  35  | }
  36  | 
  37  | async function mockRegisterSuccess(page: Page) {
  38  |   await page.route(`${BACKEND}/auth/register`, (route) =>
  39  |     route.fulfill({
  40  |       status: 201,
