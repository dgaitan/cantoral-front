...
- Name: auth-flow.spec.ts >> Verify page >> shows 6 digit inputs with first field focused
- Location: tests/e2e/auth-flow.spec.ts:218:7
...
Locator:  locator('[data-otp-digit]')
Expected: 6
Received: 0
Timeout:  5000ms
...
Call log:
  ...
  - waiting for locator('[data-otp-digit]')
